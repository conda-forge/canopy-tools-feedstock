...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/canopy-tools-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/canopy-tools-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add canopy-tools
# for installing globally
pixi global install canopy-tools
```
...
It is possible to list all of the versions of `canopy-tools` available on your platform:
...
```
pixi search canopy-tools --channel conda-forge
```
